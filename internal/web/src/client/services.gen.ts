 ...
 * @throws ApiError
 */
export const postApiEventRules = (data: PostApiEventRulesData): CancelablePromise<PostApiEventRulesResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/api/event-rules',
    body: data.requestBody,
    mediaType: 'application/json',
