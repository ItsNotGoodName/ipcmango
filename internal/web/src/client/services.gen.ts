 ...
 * @param data.perPage
 * @param data.device
 * @returns ListFiles OK
 * @throws ApiError
 */
export const getApiFiles = (data: GetApiFilesData = {}): CancelablePromise<GetApiFilesResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/api/files',
    query: {
        page: data.page,
